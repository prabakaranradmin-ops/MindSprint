...
**Doc version:** 4.14 · **Status date:** 2026-07-22 (see Changelog, §25)
...
| O11 | Product owner + content author | **Science has zero Middle/Senior-appropriate content** (found in §26.12): all 5 Science mechanics reuse Junior's exact same fixed banks and skill ids regardless of tier — a 12-year-old sees identical "living or non-living" sorting content a 6-year-old sees, just under relabeled stage titles. Unlike Math (§26.10's difficulty matrix) and Words (real comprehension/word-problem content), Science never got tiered content. Needs real content authoring (age-appropriate biology/chemistry concepts for Middle/Senior), not a code fix — scope/volume is a product + content decision, same category as §15.1's ongoing Junior bank-growth work. | Not gating; Science is playable at every tier today, just not age-differentiated |
